...
ke_analyse('results\\SMA_CO_enum&gradOpt_no_diff\\enumeration\\*pkl')
ke_analyse('results\\SMA_CO_gradOpt_HyperParameterDiff\\gradOpt_budget_budget_80_q_1_exp_40_100\\*pkl')